...
This DAG relies on three variables, loaded from JSON-file
"""
...
with open('/home/airflow/gcs/dags/example.json') as f:
    data = json.load(f)
...
HADOOP_JOB = {
    "reference": {"project_id": data["GCP_PROJECT"]},
...
default_dag_args = {
    ...
    'project_id': data["GCP_PROJECT"],
    'region': data["GCP_REGION"],
}


with models.DAG(
        'composer_hadoop_demo_json_env',
